...
const adPlans = [
  {
    ...
    price: "¥150,000 / 月",
    description:
      "トップページのヒーローセクション直下に設置される広告エリアを丸ごと占有。大型フェアや新料金プラン、店舗コンセプトをサイト最上部から一斉に訴求できます。",
    reach: "サイト全体",
    slot: "1枠",
  },
  {
    ...
    price: "¥100,000 / 月",
    description:
      "トップページ最下部のBOTTOM広告エリアに掲載。来店直前のユーザーへクーポン・同伴フェア・延長無料といった即効性の高い施策を届けられます。",
    reach: "サイト全体（離脱直前）",
    slot: "1枠",
  },
  {
    ...
    price: "¥80,000 / 月",
    description:
      "各エリアのランキングページに広告カードを常設。エリア限定キャンペーンやフリー来店特典を意思決定直前のユーザーへ届けられます。",
    reach: "指定エリア",
    slot: "エリアあたり1枠",
  },
];
